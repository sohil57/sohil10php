        ...
        {  
            ...
            try {
              ...
              require 'PHPMailer/SMTP.php';  
                ...
                //Recipients
                $mail->setFrom('sherasiyasohil57@gmail.com', 'set from');
                $mail->addAddress($_POST["email"], 'Recciepeint');
                //Content
                $mail->isHTML(true);                                  //Set email format to HTML
                $mail->Subject = 'Thanks for created account with sohil Yummy Mummy Resturents will promiss provides Best Foods';
                ...
                <br><br>
                Hey There is the Sohil yummy Mummy, <br>
                Its' The Sohil Yoummy Mummy Thanks for creating your account with Us we will promises to delivred Best Yummy Food Please Visit at once time in Our resturents
                <br><br>
